...
if __name__ == "__main__":
    ...
    check(list(), 200, '[]')
    check(get('de305d54-75b4-431b-adb2-eb6b9e546013'), 404)
    check(put('de305d54-75b4-431b-adb2-eb6b9e546013', sample_court_json_1), 201)
    check(put('de305d54-75b4-431b-adb2-eb6b9e546013', 'bad json'), 400)
    check(put('de305d54-75b4-431b-adb2-eb6b9e546013', sample_court_json_1), 200)
    check(list(), 200, '['+sample_court_json_1+']')
    check(get('de305d54-75b4-431b-adb2-eb6b9e546013'), 200, sample_court_json_1)
    check(list(), 200, '['+sample_court_json_1+']')
    check(delete('de305d54-75b4-431b-adb2-eb6b9e546013'), 200)
    check(list(), 200, '[]')
    check(delete('all-the-things'), 200)
    print "done"
